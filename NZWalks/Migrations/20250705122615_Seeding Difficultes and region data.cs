...
{
    /// <inheritdoc />
    public partial class SeedingDifficultesandregiondata : Migration
    { 
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0558aa34-9036-40c7-a69b-f316a86a9b89") , "High" },
                    { new Guid("82b8edf3-86b6-4a5f-9867-20352c0fefc5"), "Low" },
                    { new Guid("87e6c8fb-b818-4a45-abd3-8b470345cba2"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0558aa34-9036-40c7-a69b-f316a86a9b89"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("82b8edf3-86b6-4a5f-9867-20352c0fefc5"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("87e6c8fb-b818-4a45-abd3-8b470345cba2"));
